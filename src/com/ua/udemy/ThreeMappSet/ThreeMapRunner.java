package com.ua.udemy.ThreeMappSet;

import com.ua.udemy.map.WordWrapper;

import java.util.*;

public class ThreeMapRunner {
    public static void main(String[] args) {
        ...
        NavigableMap<AverageStudentGrade, Set<SubjectGrade>> scholarshipStudent = (NavigableMap<AverageStudentGrade, Set<SubjectGrade>>) grades.tailMap(border);
        System.out.println("--------------------------------------------");
        System.out.println("ScholarshipStudents");
        printGrades(scholarshipStudent.descendingMap(),false );
        ...
        System.out.println(scholarshipStudent.lastEntry());
    }
    ...
    private static void printGrades(Map<AverageStudentGrade, Set<SubjectGrade>> grades, boolean printValue) {
        ...
        for (AverageStudentGrade qr : averageGrades) {
            System.out.println(qr);
            if (printValue) {
                System.out.println(grades.get(qr));
            }
        }
