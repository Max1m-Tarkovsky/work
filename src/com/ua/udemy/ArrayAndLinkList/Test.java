...
public class Test {
        ...
        while (param != 0) {
            ...
            switch (param) {
                case 1:
                    ...
                    System.out.println("Pleas choose an action by typing [0-6]");
                ...
                case 3:
                    ...
                    break;
                case 4:
                    System.out.println("Pleas enter a task to remove ");
                    scanner.nextLine();
                    ...
                    break;
                case 5:
                    System.out.println("Pleas enter the task to get priority ");
                    scanner.nextLine();
    ...
    private static void printOut() {
        System.out.println("Please choose an action Press:\n"
                ...
                + "5 to ger task priority or number in the list \n "
